 <!-- s-extra
	...
	<section class="s-extra">
				...
				<div class="block-1-2 block-m-full popular__posts">
					...
					<article class="col-block popular__post">
						...
						<section class="popular__meta">
								<span class="popular__author"><span><?php esc_html_e( 'By' ); ?></span> <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><?php the_author(); ?></a></span>
		...
		<div class="row bottom tags-wrap">
			...
			$philosophy_footer_tag_items   = apply_filters( 'philosophy_footer_tag_item', get_tags() );
			?>
		...
		<div class="s-footer__main">
			<div class="row">
				<div class="col-two md-four mob-full s-footer__sitelinks">
					<h4><?php esc_html_e( 'Quick Links', 'philosophy' ); ?></h4>
				...
				<div class="col-two md-four mob-full s-footer__archives">
					<h4><?php esc_html_e( 'Archives', 'philosophy' ); ?></h4>
				...
				<div class="col-two md-four mob-full s-footer__social">
					<h4><?php esc_html_e( 'Social', 'philosophy' ); ?></h4>
